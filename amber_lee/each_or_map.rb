...
tags = []
  ...
  tags << post [:tags] #<< puts tags into the empty array of tags []
end

tags = tags.flatten.uniq #this is saying that it has looped through all the posts, and now you are getting rid of the arrays in the arrasy.

#tags = tags.uniq  #this is saying that you want tags to return only unique results.  

#you can also do this instead, and put it into one line. 
